	   ...
	   //	   const TString OutPutRootFileName = "ch1_splitted_TF1_WV")
{
  ...
  for (size_t isamp=0; isamp<samples.size(); isamp++) {
	...
	//if (l_pt1>30 && l_pt2>30) std::cout << "dilepton" << std::endl;
	//else continue;
	//if (dilep_m>76 && dilep_m<107) std::cout << "mass peak" << std::endl;
	//else continue;
	//if (ungroomed_PuppiAK8_jet_pt>200 && abs(ungroomed_PuppiAK8_jet_eta)<2.4) std::cout << "boosted2" << std::endl;
	//else continue;
	//if ( PuppiAK8_jet_tau2tau1<0.55 ) std::cout << "V" << std::endl;
	//else continue;
  ...
  TFile *outFile = new TFile("SMEWK.root","RECREATE"); 
  
  TString OutRootFileSuffix = "_NoBinbyBin";
  TString OutPutRootFileName = "SMEWK";
  ...
  sprintf(outputLimitsShape,"SMEWK_Wjj.txt");
  ...
  newcardShape << Form("shapes * * SMEWK.root Wjj/$PROCESS Wjj/$PROCESS_$SYSTEMATIC\n");
  newcardShape << Form("shapes data_obs * SMEWK.root Wjj/dataWjj\n");
  ...
  //Zjj
  sprintf(outputLimitsShape,"SMEWK_Zjj.txt");
  ...
  newcardShape << Form("shapes * * SMEWK.root Zjj/$PROCESS Zjj/$PROCESS_$SYSTEMATIC\n");
  newcardShape << Form("shapes data_obs * SMEWK.root Zjj/dataZjj\n");
  ...
  //WV
  sprintf(outputLimitsShape,"SMEWK_WV.txt");
  ...
  newcardShape << Form("shapes * * SMEWK.root WV/$PROCESS WV/$PROCESS_$SYSTEMATIC\n");
  newcardShape << Form("shapes data_obs * SMEWK.root WV/dataWV\n");
  ...
  sprintf(outputLimitsShape,"SMEWK_ZV.txt");
  ...
  newcardShape << Form("shapes * * SMEWK.root ZV/$PROCESS ZV/$PROCESS_$SYSTEMATIC\n");
  newcardShape << Form("shapes data_obs * SMEWK.root ZV/dataZV\n");
