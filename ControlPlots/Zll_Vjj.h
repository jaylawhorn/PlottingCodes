...
// { "mass_llj_PuppiAK8", 	600, 2000, 19, 1, 	"M_{ww}"  , "mass_llj_PuppiAK8_19Bins" , 600, 2000, 19, 0}, 
 { "mass_llj_PuppiAK8", 	0, 1950, 13, 1, 	"M_{ZV}"  , "mass_llj_PuppiAK8_4Bins" , 0, 1950, 13, 0}, 
//
...
////////	Leptonic & Hadronic W-boson 
 { "dilep_pt",	0,700, 10,3,	"Z_{ll} p_{T} (GeV)",		"dilep_pt",	0,700, 10, 0}, 
// { "dilep_eta",	-2.5,2.5, 20,1,	"W_{lep}(#eta)",	"dilep_eta",	-2.5,2.5, 20, 0}, 
// { "dilep_phi",	-3.5,3.5, 10,1,	"Z_{lll} (#phi)",	"dilep_phi", 	-3.5,3.5, 10, 0}, 
 { "dilep_m",	76,107, 6,3,	"M_{ll} (GeV)",		"dilep_m", 	76,107, 6, 0}, 
// 
 { "ungroomed_PuppiAK8_jet_pt",	0, 200, 5, 3, "V(jj) p_{T} (GeV)",		"ungroomed_PuppiAK8_jet_pt",  0, 200, 5, 1 },
...
// { "PuppiAK8_jet_mass_so_corr", 	40, 150, 22, 3, "AK8 Softdrop mass (GeV)",	"AK8_mass_so", 40.0, 150, 22, 1},
 { "PuppiAK8_jet_mass_so_corr", 	40, 150, 22, 3, "V(jj) mass (GeV)",	"AK8_mass_so_11bin", 40.0, 150, 22, 1},
